...
class RegistroController extends AbstractActionController
{
    ...
    public function indexAction()
    {
        ...
        if($this->getRequest()->isPost()) {
            $form->setValidationGroup('username', 'email', 'firstName', 'lastName', 'password', 'passwordVerify', 'question', 'answer', 'csrf', 'captcha','estado','municipios','apellidoMaterno','calle','numeroExt','numeroInt','colonia','codigoPostal','telefono1','telefono2');
